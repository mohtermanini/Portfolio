...
`;function wo({children:e,backgroundColor:t}){return c.jsxs(j0,{backgroundColor:t,children:[c.jsx("hr",{}),c.jsx("h2",{className:"c-text--display-sm c-text--bold",children:e})]})}const N0=ke.section`
  a {
...
`;function gx({id:e}){const{selectedProjectId:t,setSelectedProjectId:n}=Ei(),[r,i]=le.useState(null);le.useEffect(()=>{Pn.forEach(o=>{o.id===e&&i(o)})},[]);function a(){n(e)}return c.jsx(hx,{className:t===e?"active":"",children:r&&c.jsxs(c.Fragment,{children:[c.jsx("button",{onClick:a,children:c.jsx("img",{src:r.mainImage})}),c.jsx("h2",{className:"c-text--title-lg c-text--bold",children:r.name})]})})}function vx(){const{selectedCategoryId:e,selectedProjectId:t,setShowProjectModal:n}=Ei(),[r,i]=le.useState(null);le.useEffect(()=>{Pn.forEach(o=>{o.id===t&&i(o)})},[t]);function a(){n(!0)}return c.jsxs(Fy,{children:[c.jsx("div",{className:"c-projects-list",children:e&&Pn.map(o=>{if(o.categoryId===e)return c.jsx(gx,{id:o.id},o.id)})}),r&&c.jsxs(c.Fragment,{children:[c.jsx("hr",{className:"c-horizontal-separator--height-5 c-horizontal-separator--color-white"}),c.jsxs("div",{className:"c-selected-project-description",children:[c.jsx("div",{className:"c-text--title-lg c-text--bold",children:r.name}),c.jsx("div",{className:"c-text--body-md",children:r.mainDescription}),c.jsx("button",{className:"btn",onClick:a,children:"More Details"})]})]})]})}const yx=ke.div`
  .modal {
    display: flex;
    top: 0;
    left: 0;
...
`;function nh({skill:e}){return c.jsxs(Ex,{children:[c.jsx("div",{className:"c-icon-container",children:c.jsx("img",{src:e.icon})}),c.jsx("span",{children:e.name})]})}function jx({name:e,description:t,sections:n,skills:r,link:i}){const[a,o]=le.useState(null);return le.useEffect(()=>{const l=[];r.forEach(s=>{l.push(Cx[s])}),o(l)},[]),c.jsxs(xx,{children:[c.jsxs("div",{className:"c-main-description",children:[c.jsx("h2",{className:"c-text--headline-sm c-text--bold",children:e}),t]}),n&&n.map(l=>c.jsxs("div",{className:"c-features",children:[c.jsx("h3",{className:"c-text--title-lg c-text--bold",children:l.title}),c.jsx("div",{className:"c-features__body",children:l.content})]},l.title)),c.jsxs("div",{className:"skills",children:[c.jsx("h3",{className:"c-text--title-lg c-text--bold",children:"Skills"}),c.jsx("ul",{className:"c-skills",children:a&&a.map(l=>c.jsx("li",{children:c.jsx(nh,{skill:l})},l.name))})]}),c.jsx("hr",{className:"c-horizontal-separator--height-1 c-horizontal-separator--color-white"}),c.jsx("div",{className:"visit-site-container",children:c.jsxs("a",{className:"btn",href:i,target:"_blank",rel:"noreferrer",children:[c.jsx("span",{children:"Visit Site"}),c.jsx(wr,{icon:M0})]})})]})}const Nx=ke.div`
  display: flex;
  flex-direction: column;
  gap: 25px;
  .main-image {
...
`;function _x({images:e}){const[t,n]=le.useState(e[0]);function r(i){n(i)}return c.jsxs(Nx,{children:[c.jsx("div",{className:"main-image",children:c.jsx("img",{src:t})}),c.jsx("ul",{children:e.map((i,a)=>c.jsx("li",{onClick:()=>{r(i)},children:c.jsx("img",{src:i})},a))})]})}function Ax(){const{selectedProjectId:e,setShowProjectModal:t}=Ei(),[n,r]=le.useState(null),i=le.useRef();le.useEffect(()=>{Pn.forEach(l=>{l.id===e&&r(l)}),document.querySelector("body").classList.add("modal-active")},[]);function a(l){l.target===i.current&&(document.querySelector("body").classList.remove("modal-active"),t(!1))}function o(){document.querySelector("body").classList.remove("modal-active"),t(!1)}return c.jsx(yx,{children:c.jsx("div",{className:"modal",ref:i,onClick:a,children:c.jsxs("div",{className:"modal-body",children:[c.jsx("button",{className:"btn btn-close",onClick:o,children:"X"}),n&&c.jsxs(c.Fragment,{children:[c.jsx("div",{className:"project-images",children:c.jsx(_x,{images:n.images})}),c.jsx(jx,{name:n.name,description:n.description,sections:n.sections,skills:n.skillsIds,link:n.link})]})]})})})}const Ix=ke.div`
  display: flex;
  flex-grow: 1;
...
`;function Tx(){const{selectedCategoryId:e,setSelectedCategoryId:t}=Ei();function n(r){t(r)}return c.jsx(Ox,{children:c.jsx("div",{className:"l-flex l-flex--column",children:px.map(r=>c.jsx("button",{className:`c-category ${e===r.id?"c-category--active":""}`,onClick:()=>{n(r.id)},children:c.jsx("h2",{className:`c-text--headline-sm ${e===r.id?"c-text--bold":""}`,children:r.name})},r.id))})})}function zx(){const{showProjectModal:e}=Ei();return c.jsxs(Ix,{children:[c.jsx(Tx,{}),c.jsx(vx,{}),e&&c.jsx(Ax,{})]})}function Lx(){return c.jsx($y,{children:c.jsxs(mx,{children:[c.jsx(wo,{backgroundColor:"rgba(32, 32, 95, 0.7)",children:"Projects"}),c.jsx(zx,{})]})})}const Rx=ke.section`
  .c-skills-body {
...
`;function $x({skillsSet:e}){return c.jsxs(Mx,{children:[c.jsxs("div",{className:"c-skill-category",children:[c.jsx("div",{className:"c-icon-container c-icon-container--large",children:c.jsx("img",{src:e.icon})}),c.jsx("h2",{className:"c-text--title-lg c-text--bold",children:e.category})]}),c.jsx("ul",{className:"c-skills",children:e.skills.map(t=>c.jsx("li",{children:c.jsx(nh,{skill:t})},t.name))})]})}function Fx(){return c.jsxs(Rx,{children:[c.jsx(wo,{backgroundColor:"rgba(90, 26, 128, 0.7)",children:"Skills"}),c.jsx("div",{className:"container-fluid",children:c.jsx("div",{className:"c-skills-body row",children:Px.map(e=>c.jsx("div",{className:"col-lg-6",children:c.jsx($x,{skillsSet:e})},e.category))})})]})}const Dx=ke.section`
...
`;function Yx(){return c.jsxs(Vx,{children:[c.jsxs("div",{className:"c-other-experience",children:[c.jsx("h2",{className:"c-text--headline-sm c-text--bold",children:"Not Enough for You?"}),c.jsxs("ul",{className:"c-list--bullet",children:[c.jsx("li",{className:"c-text--body-md",children:"I have a bachelor’s degree in Informatics Engineering, a five years computer science programe."}),c.jsx("li",{className:"c-text--body-md",children:"I graduated at the top of my class with a GPA of 87%."}),c.jsxs("li",{className:"c-text--body-md",children:["I solved over 850 problems which involved different algorithms and data structures onwebsites like Codeforces, UVa Online Judge, Spoj.",c.jsxs("p",{className:"stoptalk-profile",children:["My profile on"," ",c.jsx("a",{href:"https://www.stopstalk.com/user/profile/Mohamad_Termanini",target:"_blank",rel:"noreferrer",children:"Stopstalk"})]})]}),c.jsx("li",{className:"c-text--body-md",children:"I participated in Aleppo Collegiate Programming Contest and got the third place."})]})]}),c.jsx("div",{className:"c-side-img-container",children:c.jsx("img",{src:Hx,className:"c-side-img-container__img"})})]})}const Qx=ke.div`
...
`;function Gx(){return c.jsxs(Qx,{children:[c.jsx(Wx,{}),c.jsx(Yx,{})]})}function Xx(){return c.jsxs(Dx,{children:[c.jsx(wo,{backgroundColor:"rgba(17, 61, 80, 0.7)",children:"Work Experience"}),c.jsx(Gx,{})]})}function Kx(){return c.jsx(c.Fragment,{children:c.jsxs("main",{children:[c.jsx(My,{}),c.jsx("hr",{className:"c-horizontal-separator--height-5 c-horizontal-separator--color-white"}),c.jsx(Lx,{}),c.jsx("hr",{className:"c-horizontal-separator--height-5 c-horizontal-separator--color-white"}),c.jsx(Xx,{}),c.jsx("hr",{className:"c-horizontal-separator--height-5 c-horizontal-separator--color-white"}),c.jsx(Fx,{}),c.jsx("hr",{className:"c-horizontal-separator--height-5 c-horizontal-separator--color-white"}),c.jsx(I0,{}),c.jsx(R0,{})]})})}ol.createRoot(document.getElementById("root")).render(c.jsx(Tn.StrictMode,{children:c.jsx(Kx,{})}));
